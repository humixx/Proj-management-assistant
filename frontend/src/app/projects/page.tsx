  ...
  return (
    <div className="flex items-center justify-center h-full">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Welcome to Project Management Assistant</h2>
        <p className="text-gray-600 mb-8">Create a new project using the sidebar to get started</p>
